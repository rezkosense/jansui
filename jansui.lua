...
local library = {
	...
	tabSize = 0,
	theme = {},
	foldername = "rezkoclient/universal",
	fileext = ".sex"
}
...
SettingSection:AddColor({text = "Accent Color", flag = "Menu Accent Color", color = Color3.fromRGB(200, 61, 200), callback = function(color)
